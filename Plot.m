...
%exportgraphics(F,PATH+"/Plots-Video/Observer/ObserverSnelPA.png",'Resolution',300)
%%
F = figure;
hold on
colororder({'b','r'})
...
legend('Simulatie','Meting','Werkelijke waarde',newline+"$x_0 = 0\ m$"+newline+"$v_0 = 0\ m/s$"+newline+"$\theta_0 = \pi\ rad$"+newline+"$\omega_0 = 0\ rad/s$")
%exportgraphics(F,PATH+"/Plots-Video/Observer/ObserverTraagPA.png",'Resolution',300)
%%
F = figure;
hold on
colororder({'b','r'})
...
xlabel('Tijd [s]')
title('\textbf{$Observer_{combinatie}$}','FontSize',45)
legend('Simulatie','Meting','Werkelijke waarde',newline+"$x_0 = 0\ m$"+newline+"$v_0 = 0\ m/s$"+newline+"$\theta_0 = \pi\ rad$"+newline+"$\omega_0 = 0\ rad/s$",'Location','southeast')
...
legend('Simulatie','Werkelijke waarde',newline+"$x_0 = 0\ m$"+newline+"$v_0 = 0\ m/s$"+newline+"$\theta_0 = 0.1\ rad$"+newline+"$\omega_0 = 0\ rad/s$",'NumColumns',3,'Location','southeast')
...
legend('Simulatie','Werkelijke waarde',newline+"$x_0 = 0\ m$"+newline+"$v_0 = 0\ m/s$"+newline+"$\theta_0 = 0.1\ rad$"+newline+"$\omega_0 = 0\ rad/s$",'Orientation','horizontal','Location','South')
...
tiles.Padding = "tight";
%exportgraphics(tiles,PATH+"/Plots-Video/ExtendedStateSpace_Derivative.png",'Resolution',300)
%% Comparative plots ESSF -> Let op om de pendulum boven te laten starten om butterfly-effect te vermijden door up-swing
%% ESSF I  
arduino = tcpclient('127.0.0.1', 6012, 'Timeout', 2*10^3);
n_samples = 240;
ts = (0:n_samples-1)*Ts;
